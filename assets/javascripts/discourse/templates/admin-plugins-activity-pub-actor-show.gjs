      ...
      <div class="activity-pub-actor-gutter">
        {{#if @controller.showForm}}
          ...
          {{#if @controller.canDelete}}
            <DButton
              @action={{@controller.deleteActor}}
              @label="admin.discourse_activity_pub.actor.delete.label"
              @title="admin.discourse_activity_pub.actor.delete.title"
              @disabled={{@controller.loading}}
              class="activity-pub-delete-actor"
            />
          {{/if}}
